...
public class SystemUtils {
    ...
    */
    ...
    private static float getJavaVersionAsFloat() {
        ...
        String str = (JAVA_VERSION_TRIMMED.length() > 2) ? JAVA_VERSION_TRIMMED.substring(0, 3) : JAVA_VERSION_TRIMMED.substring(0, 2); // CUSTOM: support for Java 11
    ...
    private static int getJavaVersionAsInt() {
        ...
        // CUSTOM: support for java 11
        String str = null;
        if (JAVA_VERSION_TRIMMED.length() == 2) {
            str = JAVA_VERSION_TRIMMED;
        } else {
            str = JAVA_VERSION_TRIMMED.substring(0, 1);
