...
<p><i class="fas fa-edit"></i> <fmt:message key="adminBar.label.designApp"/>: <input id="appNameValue" type="hidden" value="<c:out value="${appDefinition.name}"/>"><span id="appName" class="nav-subtitle"><c:out value="${appDefinition.name}"/></span></p>
