...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="console.app.message.create.label.title"/>
    </div>

    <div id="main-body-content">
        <form:form id="createMessage" action="${pageContext.request.contextPath}/web/console/app/${appId}/${appVersion}/message/submit/create" method="POST" commandName="message" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input"><form:input path="messageKey" cssErrorClass="form-input-error" /> *</span>
                </div>
                <div class="form-row">
    ...
    <script type="text/javascript">
        function validateField(){
            ...
            if(!idMatch){
                var alertString = '';
                if(!idMatch){
                    alertString = '<fmt:message key="console.app.message.error.label.idInvalid"/>';
                    $("#messageKey").focus();
                }
                alert(alertString);
            }else{
