...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="console.app.message.edit.label.title"/>
    </div>

    <div id="main-body-content">
        <form:form id="createMessage" action="${pageContext.request.contextPath}/web/console/app/${appId}/${appVersion}/message/submit/edit" method="POST" commandName="message" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input">${message.id}<input id="id" type="hidden" value="${message.id}" name="id"/></span>
                </div>
                <div class="form-row">
