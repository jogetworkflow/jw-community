...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createMessage" action="${pageContext.request.contextPath}/web/console/app/${appId}/${appVersion}/message/submit/edit" method="POST" commandName="message" cssClass="form blockui">
