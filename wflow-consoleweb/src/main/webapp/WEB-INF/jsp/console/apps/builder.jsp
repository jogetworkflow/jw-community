...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/at/permission.js?build=<fmt:message key="build.number"/>"></script>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/js/at/permission.css?build=<fmt:message key="build.number"/>">
