...
<li id="nav-app-resources"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/app/${appId}/${appVersion}/resources"><span class="nav-steps">3</span> <fmt:message key="console.header.submenu.label.resources"/></a></li>
<li id="nav-app-props"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/app/${appId}/${appVersion}/properties"><span class="nav-steps">4</span> <fmt:message key="console.header.submenu.label.properties"/></a></li>
