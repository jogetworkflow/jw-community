...
<li id="nav-apps-link"><a class="nav-link" href="${pageContext.request.contextPath}/web/desktop/apps"><i class="fa fa-arrow-circle-left" style="font-size: 20px; width: 17px; margin-right: 6px;"></i> <fmt:message key="console.header.submenu.label.allApps"/></a></li>
