...
<li id="nav-apps" style="margin-top: 20px"><a class="nav-link" href="${pageContext.request.contextPath}/web/desktop/apps"><i class="icon-circle-arrow-left" style="font-size: 20px; width: 17px; margin-right: 6px;"></i> <fmt:message key="console.header.submenu.label.allApps"/></a></li>
