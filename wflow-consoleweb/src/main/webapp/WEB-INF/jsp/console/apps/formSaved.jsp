        ...
        <c:otherwise>
            ...
            <script type="text/javascript">
                ...
                function launchFormBuilder() {
                    var formBuilder = window.parent.open("${pageContext.request.contextPath}/web/console/app/<c:out value="${appId}"/>/${appDefinition.version}/form/builder/<c:out value="${formId}"/>", "nv-form-window");
                    if (formBuilder) {
                        closeDialog();
                    }
                }
