...
<commons:popupHeader />
    ...
    <script type="text/javascript">
        ...
        function validateField(){
            ...
            if(!idMatch){
                alertStringList = UI.addAlertListItem(alertStringList, '<ui:msgEscJS key="console.directory.user.error.label.usernameInvalid"/>');
                $("#username").focus();
                valid = false;
            }
            ...
            if($("[name=password]").val() == "" || $("[name=confirmPassword]").val() == ""){
                alertStringList = UI.addAlertListItem(alertStringList, '<ui:msgEscJS key="console.directory.user.error.label.passwordNotEmpty"/>');
                valid = false;
