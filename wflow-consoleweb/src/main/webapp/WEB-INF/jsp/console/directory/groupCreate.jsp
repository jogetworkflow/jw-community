...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createGroup" action="${pageContext.request.contextPath}/web/console/directory/group/submit/create" method="POST" commandName="group" cssClass="form">
    ...
    <script type="text/javascript">
        function validateField(){
            ...
            if(!idMatch){
                var alertString = '';
                if(!idMatch){
                    alertString = '<fmt:message key="console.directory.group.error.label.idInvalid"/>';
                    $("#id").focus();
                }
                alert(alertString);
            }else{
