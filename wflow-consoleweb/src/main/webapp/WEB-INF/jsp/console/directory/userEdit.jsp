...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createUser" action="${pageContext.request.contextPath}/web/console/directory/user/submit/edit" method="POST" commandName="user" cssClass="form blockui">
