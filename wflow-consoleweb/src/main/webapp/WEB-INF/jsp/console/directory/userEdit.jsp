...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createUser" action="${pageContext.request.contextPath}/web/console/directory/user/submit/edit" method="POST" commandName="user" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input">${user.username}<input id="id" type="hidden" value="${user.id}" name="id"/></span>
                </div>
                <div class="form-row">
