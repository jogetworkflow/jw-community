...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="console.directory.department.user.assign.label.title"/>
    </div>
    ...
    <script type="text/javascript">
        ...
        function assignUsers(selectedIds){
             if (confirm('<fmt:message key="console.directory.department.user.assign.label.confirmation"/>')) {
                var callback = {
                    success : function() {
                        parent.location.reload(true);
                    }
                }
                var request = ConnectionManager.post('${pageContext.request.contextPath}/web/console/directory/dept/${id}/user/assign/submit', callback, 'ids='+ selectedIds);
            }
        }
