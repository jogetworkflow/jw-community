...
<commons:popupHeader />
    ...
    <script type="text/javascript">
        ...
        function setHod(selectedId){
            UI.confirm('<ui:msgEscJS key="console.directory.department.hod.set.label.confirmation"/>',
                () => {
                    UI.blockUI(); 
                    var callback = {
                        success : function() {
                    ...
                    confirmButtonLabel: '<ui:msgEscJS key="console.directory.department.hod.set.label"/>',
