...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createDept" action="${pageContext.request.contextPath}/web/console/directory/dept/submit/create?orgId=${organization.id}&parentId=${parent.id}" method="POST" commandName="department" cssClass="form blockui">
    ...
    <script type="text/javascript">
        function validateField(){
            ...
            if(!idMatch){
                var alertString = '';
                if(!idMatch){
                    alertString = '<ui:msgEscJS key="console.directory.department.error.label.idInvalid"/>';
                    $("#id").focus();
                }
                alert(alertString);
            }else{
