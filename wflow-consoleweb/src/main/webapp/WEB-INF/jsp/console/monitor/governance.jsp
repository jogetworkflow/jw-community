...
<script>
    ...
    $(function(){
        GovernanceUtil.init('${interval}', {
            ...
            activate: '<ui:msgEscJS key="console.governance.activate"/>',
            deactivateConfirm : '<ui:msgEscJS key="console.governance.deactivate.confirm"/>',
            deactivate: '<ui:msgEscJS key="console.governance.deactivate"/>',
            deleteConfirm : '<ui:msgEscJS key="console.governance.deleteData.confirm"/>',
            deleteData:  '<ui:msgEscJS key="console.governance.deleteData"/>',
            deactivate: '<ui:msgEscJS key="console.governance.deactivate"/>',
