...
<c:if test="${!isVirtualHostEnabled}">
    <li id="nav-monitor-apm"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/monitor/apm"><span class="nav-steps">&nbsp;</span><fmt:message key="apm.performance"/></a></li>
</c:if>
