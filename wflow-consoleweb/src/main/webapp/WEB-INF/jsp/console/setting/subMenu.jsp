...
<li id="nav-setting-incoming-email"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/setting/incomingEmail"><span class="nav-steps"><i class="fas fa-envelope"></i></span><fmt:message key="console.header.submenu.label.setting.incomingEmail"/></a></li>
