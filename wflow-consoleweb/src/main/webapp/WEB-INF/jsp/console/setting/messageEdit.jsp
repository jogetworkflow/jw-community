...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createMessage" action="${pageContext.request.contextPath}/web/console/setting/message/submit/edit" method="POST" modelAttribute="message" cssClass="form blockui">
