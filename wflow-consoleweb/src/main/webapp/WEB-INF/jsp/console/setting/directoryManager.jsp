            ...
            <div class="section-list-item">
                ...
                <div class="section-list-item-actions">
                    <c:if test="${isDmConfigurable}">
                        <button type="button" id="dm-config" class="btn button-action-main console-primary" onclick="configureDirectoryManagerImpl()"><fmt:message key="general.method.label.configPlugin"/></button>
                    </c:if>
                    <button type="button" id="dm-change" class="btn button-action-main console-tertiary" onclick="selectDirectoryManagerImpl()"><fmt:message key="console.setting.directory.label.changePlugin"/></button>
                </div>
            </div>
        </section>
