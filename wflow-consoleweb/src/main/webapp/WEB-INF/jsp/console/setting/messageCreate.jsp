...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createMessage" action="${pageContext.request.contextPath}/web/console/setting/message/submit/create" method="POST" commandName="message" cssClass="form blockui">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input"><form:textarea path="message" cssErrorClass="form-input-error" /><span style="position: absolute;padding-left: 4px;"> *</span></span>
                </div>
            </fieldset>
