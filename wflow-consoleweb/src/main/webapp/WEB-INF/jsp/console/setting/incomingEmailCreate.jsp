...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="console.setting.incomingEmail.create.label.title"/>
    </div>

    <div id="main-body-content">
        <form:form id="createIncomingEmail" action="${pageContext.request.contextPath}/web/console/setting/incomingEmail/submit/create" method="POST" commandName="incomingEmail" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input"><form:input path="priority" cssErrorClass="form-input-error" size="30" value="10" /> *</span>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <span class="form-input"><form:input path="folder" cssErrorClass="form-input-error"  size="30" value="inbox"/> *</span>
                </div>
                <div class="form-row">
    ...
    <script type="text/javascript">
        function validateField(){
        	...
        	if(submit) {
        	    $("form#createIncomingEmail").submit();
            }
        }
