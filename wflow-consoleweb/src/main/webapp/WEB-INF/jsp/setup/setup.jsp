...
<html lang="${lang}" system-theme="light">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/js/fontawesome6/css/all.min.css">
...
//                        $("#setupStatus").append(setupResult);
                ...
                selectType: function() {
                    ...
                    if (dbType === "oracle") {
                        ...
                        $("#jdbcUrl").val("jdbc:postgresql://" + dbHost + ":" + dbPort + "/" + dbName);
