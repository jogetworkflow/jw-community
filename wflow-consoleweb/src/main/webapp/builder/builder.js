...
//        }
    ...
    renderBuilderMenu : function(data) {
        ...
        $("<div id='dragIcon' style='text-align:center;width:35px;' title='"+get_cbuilder_msg("abuilder.dragTooltipMessage")+"'><i class='fas fa-grip-vertical'></i></div>").insertAfter("#builder-quick-nav .backToApp");
