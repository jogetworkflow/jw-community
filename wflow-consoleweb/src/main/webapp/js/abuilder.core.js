AppBuilder = {
    ...
    initBuilder: function (callback) {
        ...
        $(".btn-group.tool").hide();
        $("#i18n-btn").before('<button class="btn btn-light" title="'+self.msg('envVariable')+'" id="variables-btn" type="button" data-toggle="button" aria-pressed="false" data-cbuilder-view="envVariables" data-cbuilder-frameurl="'+CustomBuilder.contextPath+'/web/console/app'+CustomBuilder.appPath+'/envVariable" data-cbuilder-action="switchView" data-hide-tool=""><i class="word-icon" style="font-size: 75%; font-weight: 350; margin-top: -2px; vertical-align: top; display:inline-block; letter-spacing: 0.6px;">{x}</i></button>');
        $("#i18n-btn").after('<button class="btn btn-light" title="'+get_cbuilder_msg('abuilder.resources')+'" id="resources-btn" type="button" data-toggle="button" aria-pressed="false" data-cbuilder-view="resources" data-cbuilder-frameurl="'+CustomBuilder.contextPath+'/web/console/app'+CustomBuilder.appPath+'/resources" data-cbuilder-action="switchView"><i class="lar la-file-image"></i> </button>\
            <button class="btn btn-light" title="'+self.msg('pluginDefault')+'" id="plugin-default-btn" type="button" data-toggle="button" aria-pressed="false" data-cbuilder-view="pluginDefaultProperties" data-cbuilder-frameurl="'+CustomBuilder.contextPath+'/web/console/app'+CustomBuilder.appPath+'/properties" data-cbuilder-action="switchView"><i class="las la-plug"></i> </button>\
            <button class="btn btn-light" title="'+self.msg('performance')+'" id="performance-btn" type="button" data-toggle="button" aria-pressed="false" data-cbuilder-view="performance" data-cbuilder-frameurl="'+CustomBuilder.contextPath+'/web/console/app/'+CustomBuilder.appId+'/performance" data-cbuilder-action="switchView"><i class="las la-tachometer-alt"></i> </button>\
            <button class="btn btn-light" title="'+self.msg('logs')+'" id="logs-btn" type="button" data-toggle="button" aria-pressed="false" data-cbuilder-view="logViewer" data-cbuilder-frameurl="'+CustomBuilder.contextPath+'/web/console/app/'+CustomBuilder.appId+'/logs" data-cbuilder-action="switchView"><i class="las la-scroll"></i> </button>');
        
        $("#design-btn").attr("title", get_cbuilder_msg('abuilder.builders')).find("span").text(get_cbuilder_msg('abuilder.builders'));
        $("#design-btn").after('<button class="btn btn-light" title="'+self.msg('versions')+'" id="versions-btn" type="button" data-toggle="button" aria-pressed="false" data-cbuilder-view="versions" data-cbuilder-frameurl="'+CustomBuilder.contextPath+'/web/console/app/'+CustomBuilder.appId+'/versioning" data-cbuilder-action="switchView" data-hide-tool=""><i class="la la-list-ol"></i> <span>'+self.msg('versions')+'</span></button>');
