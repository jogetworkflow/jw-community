UI = {
   ...
   isMobileUserAgent: function() {
    ...
    showConsoleToast: function(id, message, icon, delay, container){
        $('<div class="toast console delete" id="toast-'+ id + '"><i id="toast-icon" class="'+ icon +'"></i><div class="toast-body">'+ message +'</div><i id="close" class="fas fa-close"></i></div>').appendTo('div#main');
        $('.toast').css({
            'opacity': '0', 
        });
