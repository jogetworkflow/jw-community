...
CREATE TABLE [wf_process_link](
	...
	[parentProcessId] [varchar](255) NULL,
	[originProcessId] [varchar](255) NULL,
PRIMARY KEY CLUSTERED 
(
	[processId] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
...
CREATE TABLE [dir_employment_report_to](
	[id] [varchar](255) NOT NULL,
	[employmentId] [varchar](255) NULL,
	[reportToId] [varchar](255) NULL,
PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY],
...
CREATE TABLE [app_package_activity_form](
	...
	[formIFrameStyle] [varchar](255) NULL,
...
CREATE TABLE [app_report_activity_instance](
	...
	[nameOfAcceptedUser] [varchar](255) NULL,
	[assignmentUsers] [text] NULL,
	[due] [datetime] NULL,
...
CREATE TABLE [app_report_package](
	...
	[packageVersion] [varchar](255) NULL,
	[appUid] [varchar](255) NULL,
PRIMARY KEY CLUSTERED 
(
	[uuid] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
...
INSERT INTO dir_user (id,username,password,firstName,lastName,email,active,timeZone) VALUES ('001','admin','admin','Admin','admin','admin@email.domain',1,'8');
