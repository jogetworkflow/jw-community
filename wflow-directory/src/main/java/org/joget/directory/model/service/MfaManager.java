...
public interface MfaManager {
     ...
     */
    boolean login(String pluginClassName, String username, HttpServletRequest request) throws ClassNotFoundException, MfaExecutionException;
     ...
     * @throws MfaExecutionException  when error occurs during MFA verification
     */
    boolean register(String pluginClassName, String username, HttpServletRequest request) throws ClassNotFoundException, MfaExecutionException;
