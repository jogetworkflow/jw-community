...
public interface MfaManager {
    ...
    /**
     * Get the register template from an MFA plugin
     *
     * @param pluginClassName the MFA plugin class name
     * @param username        the current user of the request
     * @param request         the HTTP request of the current session
     * @return the template generated by the plugin
     * @throws ClassNotFoundException when the plugin cannot be found
     * @throws MfaExecutionException when the plugin encountered an error
     */
    String getRegisterTemplate(String pluginClassName, String username, HttpServletRequest request) throws ClassNotFoundException, MfaExecutionException;

    /**
     * Gets the login template from an MFA plugin
     *
     * @param pluginClassName the MFA plugin class name
     * @param username        the current user of the request
     * @param request         the HTTP request of the current session
     ...
     * @throws MfaExecutionException when the plugin encountered an error
     */
    String getLoginTemplate(String pluginClassName, String username, HttpServletRequest request) throws ClassNotFoundException, MfaExecutionException;
