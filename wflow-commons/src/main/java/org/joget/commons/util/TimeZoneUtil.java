...
public class TimeZoneUtil {
    ...
    /**
     * Retrieve list of GMT Time Zone
     * @return a map of GMT and its countries
     */
    ...
    /**
     * Convert Date to String based on GMT and Date Format
    ...
    public static String convertToTimeZone(Date time, String gmt, String format) {
        ...
        try {
            ...
            dateFormat = new SimpleDateFormat(ResourceBundleUtil.getMessage("console.setting.general.default.systemDateFormat"));
        }
