...
import static org.hibernate.tool.schema.spi.Exporter.NO_COMMANDS;

/**
 * TODO CUSTOM : Override this class to set a max length or alter data type when it is form data column 
