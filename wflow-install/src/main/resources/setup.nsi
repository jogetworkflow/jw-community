...
Section "Joget DX" SecJoget
  ...
  ${If} $INSTALL_TYPE != "${INSTALL_TYPE_FULL}"
    ...
    DoUpgrade:
        ...
        File /oname=apache-tomcat-$EXISTING_TOMCAT_VERSION\webapps\jw.war apache-tomcat-11.0.24\webapps\jw.war
  ...
  CreateDirectory "$INSTDIR\apache-tomcat-11.0.24\webapps"
  File /oname=apache-tomcat-11.0.24\webapps\jw.war apache-tomcat-11.0.24\webapps\jw.war
  CreateDirectory "$INSTDIR\data"
  File /oname=data\jwdb-empty.sql data\jwdb-empty.sql
  File /oname=data\jwdb-sample.sql data\jwdb-sample.sql
  ;File docs
...
${If} $INSTALL_TYPE == "${INSTALL_TYPE_FULL}"
  ;Tomcat File Here
  File /r /x *.war apache-tomcat-11.0.24
  File tomcat-run.bat
...
Function CheckUpgrade
  ...
  ${If} ${FileExists} $INSTDIR\apache-tomcat-6.0.18\webapps\wflow-designerweb.war
    ...
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.24\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.24"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.22\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.22"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.21\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.21"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.18\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.18"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.13\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.13"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.10\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.10"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.9\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.9"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.8\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.8"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.6\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.6"
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.5\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.5"
    ...
    ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-11.0.0\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "11.0.0"
...
Section "Uninstall"
  ...
  RmDir /r "$INSTDIR\apache-tomcat-11.0.24\webapps\jw"
  Delete "$INSTDIR\apache-tomcat-11.0.24\webapps\jw.war"
