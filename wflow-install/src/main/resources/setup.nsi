...
Section "Joget DX" SecJoget
  ...
  ${If} $INSTALL_TYPE != "${INSTALL_TYPE_FULL}"
    ...
    DoUpgrade:
        ...
        File /oname=apache-tomcat-$EXISTING_TOMCAT_VERSION\webapps\jw.war apache-tomcat-9.0.120\webapps\jw.war
  ...
  CreateDirectory "$INSTDIR\apache-tomcat-9.0.120\webapps"
  File /oname=apache-tomcat-9.0.120\webapps\jw.war apache-tomcat-9.0.120\webapps\jw.war
  CreateDirectory "$INSTDIR\data"
  File /oname=data\jwdb-empty.sql data\jwdb-empty.sql
  File /oname=data\jwdb-sample.sql data\jwdb-sample.sql
  ;File docs
...
${If} $INSTALL_TYPE == "${INSTALL_TYPE_FULL}"
  ;Tomcat File Here
  File /r /x *.war apache-tomcat-9.0.120
  File tomcat-run.bat
...
Function CheckUpgrade
  ...
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.120\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.120"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.118\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.118"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.117\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.117"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.115\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.115"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.111\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.111"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.108\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.108"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.107\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.107"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.106\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.106"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.104\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.104"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.102\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.102"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.98\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.98"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.97\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.97"
  ${ElseIf} ${FileExists} $INSTDIR\apache-tomcat-9.0.90\webapps\jw.war
    StrCpy $INSTALL_TYPE ${INSTALL_TYPE_UPDATE}
    StrCpy $EXISTING_TOMCAT_VERSION "9.0.90"
...
Section "Uninstall"
  ...
  RmDir /r "$INSTDIR\apache-tomcat-9.0.120\webapps\jw"
  Delete "$INSTDIR\apache-tomcat-9.0.120\webapps\jw.war"
