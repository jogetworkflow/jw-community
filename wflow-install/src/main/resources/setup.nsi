...
Section "Joget Workflow" SecJoget
  ...
  ${If} $INSTALL_TYPE != "${INSTALL_TYPE_FULL}"
    ...
    DoUpgrade:
        ...
        File /oname=apache-tomcat-$EXISTING_TOMCAT_VERSION\webapps\jw.war apache-tomcat-8.5.9\webapps\jw.war
        File /oname=apache-tomcat-$EXISTING_TOMCAT_VERSION\webapps\jwdesigner.war apache-tomcat-8.5.9\webapps\jwdesigner.war
  ...
  CreateDirectory "$INSTDIR\apache-tomcat-8.5.9\webapps"
  File /oname=apache-tomcat-8.5.9\webapps\jw.war apache-tomcat-8.5.9\webapps\jw.war
  File /oname=apache-tomcat-8.5.9\webapps\jwdesigner.war apache-tomcat-8.5.9\webapps\jwdesigner.war
  CreateDirectory "$INSTDIR\data"
  File /oname=data\jwdb-empty.sql data\jwdb-empty.sql
  File /oname=data\jwdb-sample.sql data\jwdb-sample.sql
  ;File docs
...
${If} $INSTALL_TYPE == "${INSTALL_TYPE_FULL}"
  ;Tomcat File Here
  File /r /x *.war apache-tomcat-8.5.9
...
Section "Uninstall"
  ...
  RmDir /r "$INSTDIR\apache-tomcat-8.5.9\webapps\jw"
  RmDir /r "$INSTDIR\apache-tomcat-8.5.9\webapps\jwdesigner"
  Delete "$INSTDIR\apache-tomcat-8.5.9\webapps\jw.war"
  Delete "$INSTDIR\apache-tomcat-8.5.9\webapps\jwdesigner.war"
