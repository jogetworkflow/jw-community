...
Section "Joget DX" SecJoget
  ...
  ${If} $INSTALL_TYPE != "${INSTALL_TYPE_FULL}"
    ...
    DoUpgrade:
        ...
        File /oname=apache-tomcat-$EXISTING_TOMCAT_VERSION\webapps\jw.war apache-tomcat-9.0.97\webapps\jw.war
  ...
  CreateDirectory "$INSTDIR\apache-tomcat-9.0.97\webapps"
  File /oname=apache-tomcat-9.0.97\webapps\jw.war apache-tomcat-9.0.97\webapps\jw.war
  CreateDirectory "$INSTDIR\data"
  File /oname=data\jwdb-empty.sql data\jwdb-empty.sql
  File /oname=data\jwdb-sample.sql data\jwdb-sample.sql
  ;File docs
...
${If} $INSTALL_TYPE == "${INSTALL_TYPE_FULL}"
  ;Tomcat File Here
  File /r /x *.war apache-tomcat-9.0.97
  File tomcat-run.bat
...
Section "Uninstall"
  ...
  RmDir /r "$INSTDIR\apache-tomcat-9.0.97\webapps\jw"
  Delete "$INSTDIR\apache-tomcat-9.0.97\webapps\jw.war"
