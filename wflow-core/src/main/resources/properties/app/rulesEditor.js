{
    ...
    addCondition : function(button) {
        ...
        $(container).append('<div class="rulerow perow condition"><table><tr><td class="revert"><i class="fas fa-exclamation" title="@@app.rulesdecision.revert@@"></i></td><td><input class="condition autocomplete required" placeholder="@@app.rulesdecision.variable@@"/><span class="label">@@app.rulesdecision.variable@@</span></td><td><select class="operation"><option value="==">@@pbuilder.label.equalTo@@</option><option value=">">@@pbuilder.label.greaterThan@@</option><option value=">=">@@pbuilder.label.greaterThanOrEqualTo@@</option><option value="<">@@pbuilder.label.lessThan@@</option><option value="<=">@@pbuilder.label.lessThanOrEqualTo@@</option><option value="true">@@pbuilder.label.isTrue@@</option><option value="false">@@pbuilder.label.isFalse@@</option><option value="contains">@@app.rulesdecision.contains@@</option><option value="listContains">@@app.rulesdecision.listContains@@</option><option value="in">@@app.rulesdecision.in@@</option><option value="regex">@@app.rulesdecision.regex@@</option></select><span class="label">@@app.rulesdecision.operation@@</span></td><td><input class="condition_value" placeholder="@@app.simpletfai.value@@"/><span class="label">@@app.simpletfai.value@@</span></td><td class="alignright"><a class="deletecondition" title="@@app.rulesdecision.deleteCondition@@"><i class="fas fa-trash-alt"></i></a></td></tr></table></div>');
