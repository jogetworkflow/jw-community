{
    ...
    addAction : function(button) {
        ...
        var row = $('<div class="rulerow perow action"><table><tr><td><select class="type"><option value="transition">@@app.rulesdecision.transition@@</option><option value="variable">@@app.rulesdecision.workflowVariable@@</option></select><span class="label">@@app.rulesdecision.type@@</span></td><td><select class="transition_name">'+toptions+'</select><span class="label">@@app.rulesdecision.transition@@</span><select class="variable_name" style="display:none;">'+voptions+'</select><span class="label">@@app.rulesdecision.workflowVariable@@</span></td><td><input class="variable_value" placeholder="@@app.rulesdecision.value@@" style="visibility:hidden;"/><span class="label">@@app.rulesdecision.value@@</span></td><td class="alignright"><a class="deleteaction" title="@@app.rulesdecision.deleteAction@@"><i class="fas fa-trash-alt"></i></a></td></tr></table></div>');
