    ...
    $.fn.extend({
        dynamicOptions : function(o){
            ...
            if($(target)){
                ...
                if (o.nonce === '') {
                    $('[name='+o.controlField+']').off("change", this, showHideChange);
                    $('[name='+o.controlField+']').on("change", this, showHideChange);
                    showHideOption(target, o);
                } else {
                    $('[name='+o.controlField+']').off("change", this, ajaxChange);
                    $('[name='+o.controlField+']').on("change", this, ajaxChange);
                    ajaxOptions(target, o);
                }
            }
            return target;
