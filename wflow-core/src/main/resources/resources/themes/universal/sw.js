...
var urlsToCache = [
        ...
        contextPath + '/js/fontawesome6/css/all.min.css',
        contextPath + '/js/fontawesome6/css/v4-shims.min.css',
        contextPath + '/js/fontawesome6/webfonts/fa-brands-400.ttf',
        contextPath + '/js/fontawesome6/webfonts/fa-brands-400.woff2',
        contextPath + '/js/fontawesome6/webfonts/fa-regular-400.ttf',
        contextPath + '/js/fontawesome6/webfonts/fa-regular-400.woff2',
        contextPath + '/js/fontawesome6/webfonts/fa-solid-900.ttf',
        contextPath + '/js/fontawesome6/webfonts/fa-solid-900.woff2',
