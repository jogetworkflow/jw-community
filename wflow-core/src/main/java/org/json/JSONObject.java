 ...
 * @version 2016-08-15
 * 
 * CUSTOM : line 234-239 to allow duplicate keys
 * CUSTOM : line 863-865 backward compatible to support use getString to get String value of int/boolean
 */
public class JSONObject {
    ...
    public JSONObject(JSONTokener x) throws JSONException {
        ...
        for (;;) {
            ...
            if (key != null) {
// CUSTOM : To allow duplicate key for backward compatible                 
//                // Check if key exists
...
//CUSTOM: backward compatible to support use getString to get String value of int/boolean     
