...
public class TFTextInput implements TensorFlowInput {
    ...
    public String getUI() {
        ...
        html += "<div><input name=\"dict\" class=\"input_dict half required\" placeholder=\""+dictionaryLabel+"\"/><span class=\"label\">"+dictionaryLabel+"</span> <div class='actions'><a class=\"choosefile btn button small\">"+chooseFileLabel+"</a> <a class=\"clearfile btn button small\">"+clearFileLabel+"</a></div></div>";
