...
public class TFImageDetectionBoxesPostProcessing implements TensorFlowPostProcessing {
    ...
    public String getUI() {
        ...
        String html = "<div><input name=\"fontsize\" class=\"post_fontsize small required\" value=\"20\" placeholder=\""+fontSizeLabel+"\"/><span class=\"label\">"+fontSizeLabel+"</span></div>";
        html += "<div><select name=\"form\" class=\"post_form quarter\"><option value=\"\">"+emptyLabel+"</option></select><span class=\"label\">"+sourceLabel+"</span><div><input name=\"image\" class=\"post_image half required\" placeholder=\""+sourceUploadFieldLabel+"\"/><span class=\"label\">"+sourceUploadFieldLabel+"</span></div></div>";
        html += "<div><select name=\"output_form\" class=\"post_output_form quarter required\"><option value=\"\"></option></select><span class=\"label\">"+outputLabel+"</span><div><input name=\"output_image\" class=\"post_output_image half required\" placeholder=\""+soutputUploadFieldLabel+"\"/><span class=\"label\">"+soutputUploadFieldLabel+"</span></div></div>";
        ...
        html += "<div><input name=\"colors\" class=\"post_colors half\" placeholder=\""+colorsFileLabel+"\"/><span class=\"label\">"+colorsFileLabel+"</span> <div class='actions'><a class=\"choosefile btn button small\">"+chooseFileLabel+"</a> <a class=\"clearfile btn button small\">"+clearFileLabel+"</a></div></div>";
        ...
        html += "<div><select name=\"variable3\" class=\"post_variable half\"><option value=\"\">"+scoreLabel+"</option></select><span class=\"label\">"+scoreLabel+"</span><div><input name=\"threshold\" class=\"post_threshold half\" placeholder=\""+thresholdLabel+"\"/><span class=\"label\">"+thresholdLabel+"</span></div></div>";
