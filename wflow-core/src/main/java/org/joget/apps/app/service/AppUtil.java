...
public class AppUtil implements ApplicationContextAware {
    ...
    public static double getArchivedProcessStatus() {
        ...
        Collection<Setting> result = setupDao.find("WHERE property like ?", new String[]{WorkflowManagerImpl.ARCHIVE_PREFIX}, null, null, null, null);
        ...
        if (!result.isEmpty()) {
            ...
            for (Setting s : result) {
                if (s.getProperty().equals(WorkflowManagerImpl.ARCHIVE_SETTING)) {
                    status = s;
                } else if (s.getProperty().equals(WorkflowManagerImpl.ARCHIVE_PROGRESS_SETTING)) {
                    statusProgress = s;
                }
            }
