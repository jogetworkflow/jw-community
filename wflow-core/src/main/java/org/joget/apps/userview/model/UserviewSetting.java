...
public class UserviewSetting extends Element {
    ...
    public String getPropertyOptions() {
        return "[{title:'" + ResourceBundleUtil.getMessage("userview.userviewsetting.configLayout") + "', properties:["
                ...
                + "{name:'mobileViewDisabled',label:'" + ResourceBundleUtil.getMessage("mobile.setting.viewDisabled") + "',type:'checkbox',value :'false',options:[{value:'true',label :''}]}]},"
                ...
                + "{title:'" + ResourceBundleUtil.getMessage("mobile.setting.options") + "',properties:["
