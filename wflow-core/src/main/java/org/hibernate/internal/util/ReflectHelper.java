 ...
 *
 * CUSTOM: Patched for https://hibernate.atlassian.net/browse/HHH-4959
 */
...
public final class ReflectHelper {
        ...
        // CUSTOM: From https://github.com/hibernate/hibernate-orm/blob/0bd7b8eac16e6966dea81b8a5991e052192a6af2/hibernate-core/src/main/java/org/hibernate/internal/util/ReflectHelper.java
	 ...
	 * Resolve a constant to its actual value.
         * CUSTOM: Patched for https://hibernate.atlassian.net/browse/HHH-4959 using https://github.com/hibernate/hibernate-orm/blob/0bd7b8eac16e6966dea81b8a5991e052192a6af2/hibernate-core/src/main/java/org/hibernate/internal/util/ReflectHelper.java
	 *
	 * @param name The name
	 * @return The value
	 */
	public static Object getConstantValue(String name) {
		boolean conventionalJavaConstants = true; // factory.getSessionFactoryOptions().isConventionalJavaConstants();
		Class clazz;
		try {
