...
public class TestAppDao {
    ...
    protected final Long TEST_PACKAGE_VERSION = Long.valueOf(1);
    ...
    @Before
    public void makeSureDataIsClean() {
    ...
    public void testCreateAppDefinition() {
        AppDefinition checkDef = loadAppDefinition(TEST_APP_ID);
        assertNull(checkDef);
    ...
    public void testPackageActivityFormMapping() {
        // create app definition
        AppDefinition appDef = createAppDefinition(TEST_APP_ID, TEST_APP_VERSION+3);
    ...
    protected AppDefinition createAppDefinition(String id, Long version) {
        ...
        return loadAppDefinitionVersion(id, version);
    }
    ...
    protected Collection<AppDefinition> listAppDefinitions(String id) {
        // query dao
        Collection<AppDefinition> resultList = appDefinitionDao.findLatestVersions(null, id, null, null, null, null, null);
        return resultList;
    }
    ...
    protected PackageDefinition createPackageDefinition(AppDefinition appDef, String packageId, Long packageVersion) {
        ...
        return packageDefinitionDao.loadAppPackageDefinition(appDef.getAppId(), appDef.getVersion());
    }
