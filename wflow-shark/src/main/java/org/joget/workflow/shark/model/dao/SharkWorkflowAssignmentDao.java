...
public class SharkWorkflowAssignmentDao extends AbstractSpringDao implements WorkflowAssignmentDao {
    ...
    public boolean migrateProcessInstance(String processId, String newVersion){
        try {
            ...
            LogUtil.error(SharkWorkflowAssignmentDao.class.getName(), e, processId);
        }
    ...
    protected WorkflowProcess transformHistoryToWorkflowProcess(SharkProcessHistory shProcess) {
        ...
        if (shProcess.getVariables() != null && !shProcess.getVariables().isEmpty()) {
            try {
                ...
                LogUtil.error(SharkWorkflowAssignmentDao.class.getName(), e, "");
            }
        }
